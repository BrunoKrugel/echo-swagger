...
[![Release](https://img.shields.io/github/release/BrunoKrugel/echo-swagger.svg?style=flat-square)](https://github.com/BrunoKrugel/echo-swagger/releases)

> [!IMPORTANT]
> This repository is just an updated fork of [swaggo/echo-swagger](https://github.com/swaggo/echo-swagger).
> The main reason for this fork is to keep the module up-to-date with the latest Echo and Swag versions, as the original repository takes some time to approve changes and release updates.
...
```sh_ "github.com/BrunoKrugel/echo-swagger/v2/example/docs"
$ swag init
```

4. Download [echo-swagger](https://github.com/BrunoKrugel/echo-swagger) by using:
